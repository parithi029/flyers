...
const slides = [
  { src: "/images/flyer/flyer copy.jpg", caption: "Hire Top Talent — Lanceboard", description: "Square social flyer composed in Photoshop with clean CTA and soft arcs." },
  { src: "/images/flyer/flyer1 copy.jpg", caption: "Studio Noir — Night in Contrast", description: "Moody poster made in Illustrator with monochrome portraits and accents." },
  { src: "/images/flyer/flyer2 copy.jpg", caption: "Glowstack Web Conference 2025", description: "Tech event flyer blending neon interface chips and QR registration." },
  { src: "/images/flyer/flyer3 copy.jpg", caption: "Innerverse Wellness Workshop", description: "Gentle serif layout with quote card and session details." },
